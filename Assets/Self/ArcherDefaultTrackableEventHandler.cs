...
/// </summary>
public class ArcherDefaultTrackableEventHandler : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        if (mTrackableBehaviour)
        {
            ...
            IdleSong = GetComponent<AudioSource>();
        }
    }
    ...
    protected virtual void OnTrackingFound()
    {
        if (mTrackableBehaviour)
        {
            ...
            if(archer)
            {
                ...
                GameObject archerP = GameObject.Instantiate(archer, this.transform, true);
                archerP.transform.position = this.transform.position;
                archerP.transform.rotation = new Quaternion();
                if (!IdleSong.isPlaying)
                {
                    IdleSong.Play();
                }
    ...
    protected virtual void OnTrackingLost()
    {
        if (mTrackableBehaviour)
        {
            ...
            // if(IdleSong.isPlaying)
            //     IdleSong.Stop();
            Destroy(GameObject.Find("ArcherXI(Clone)"));
        }
